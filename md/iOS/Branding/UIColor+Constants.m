...
+ (UIColor*)colorOfTintSelectedUITabBar {
    return [UIColor colorWithRed:143/255.0f green:255/255.0f blue:199/255.0f alpha:1.0];
}

//Tint color for non selected tab bar item (only works with the labels)
+ (UIColor*)colorOfTintNonSelectedUITabBar {
    return [UIColor colorWithRed:87/255.0f green:255/255.0f blue:238/255.0f alpha:1.0];
}
