...
+ (UIColor*)colorOfTintSelectedUITabBar {
    return [UIColor colorWithRed:69/255.0f green:255/255.0f blue:94/255.0f alpha:1.0];
}

//Tint color for non selected tab bar item (only works with the labels)
+ (UIColor*)colorOfTintNonSelectedUITabBar {
    return [UIColor colorWithRed:77/255.0f green:195/255.0f blue:255/255.0f alpha:1.0];
}
